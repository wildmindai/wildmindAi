...
const StickerGneration: React.FC = () => {
    ...
    <div className="relative flex flex-col items-center justify-center min-h-screen bg-[#100b21] text-white overflow-hidden">
      ...
      <main className="relative z-10 flex flex-col items-center justify-center text-center px-4 space-y-8 w-full">
        ...
        <p className="max-w-xl text-gray-400">
          Create awe-inspiring masterpieces effortlessly and explore the endless possibilities of AI generated stickers. Enter a prompt, choose a style, and watch Imagine – AI art generator bring your ideas to life!
        </p>
...
export default StickerGneration
